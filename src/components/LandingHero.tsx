...
export default function LandingHero() {
	return (
		<>
			...
			<h1 className="text-white text-7xl w-fit absolute text-left top-64 left-20 p-0">
				TrustAuthX Light <br/>for Business, <br />
				Delight for Devs.
			</h1>
			<div className="text-white absolute text-left top-[32rem] left-20 flex items-center gap-20 z-10">
				<button className="flex items-center gap-3 border-[#F35815] border-2 rounded-full z-10 py-3 px-5">
