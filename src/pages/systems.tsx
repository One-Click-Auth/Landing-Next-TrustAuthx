...
and applications"
          ...
          <Card
            icon={"/amazon.svg"}
            name="Amazon"
            description="Provides customers with a comprehensive shopping 
experience by giving them seamless access to 
Amazon's powerful e-commerce platforms such as 
product listing, inventory management and secure 
payment systems"
          />
        </div>
      </div>
